const CardTask = ({theme, title, description, date}) => {
  return (
    <div className="flex flex-col bg-white w-72 h-fit rounded-md py-4 px-6 border">
      <h3 className="text-center font-bold text-xl text-gray-800 pb-2">
        {theme}
      </h3>
      <h3 className="text-base font-semibold text-gray-900 py-2">{title}</h3>
